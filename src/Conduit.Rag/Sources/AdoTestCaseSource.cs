...
public sealed class AdoTestCaseSource(SourceDefinition definition, IAdoClient ado) : ISource
{
    ...
    /// <summary>
    /// Strips HTML tags from ADO's test step XML format and renders each step as plain text.
    /// ADO stores test steps as XML like: &lt;steps&gt;&lt;step&gt;&lt;parameterizedString&gt;...&lt;/parameterizedString&gt;&lt;/step&gt;&lt;/steps&gt;
    /// </summary>
    private static string ParseTestSteps(string stepsXml)
    {
        // Strip all XML/HTML tags — simple and robust for this use case
